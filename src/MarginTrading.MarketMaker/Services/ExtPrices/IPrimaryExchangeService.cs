...
namespace MarginTrading.MarketMaker.Services.ExtPrices
{
    ...
    {
        [CanBeNull]
        ExchangeQuality GetPrimaryExchange(string assetPairId, ImmutableDictionary<string, ExchangeErrorStateEnum> errors, DateTime now, string currentProcessingExchange);
