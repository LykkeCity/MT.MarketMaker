...
namespace MarginTrading.MarketMaker.Services.ExtPrices.Implementation
{
    internal class ExtPricesSettingsService : IExtPricesSettingsService
    {
        ...
        public ImmutableSortedDictionary<string, decimal> GetHedgingPreferences(string assetPairId)
        {
            return GetAllExchanges(assetPairId).ToImmutableSortedDictionary(e => e.Key,
        ...
        public ImmutableSortedDictionary<string, AssetPairExtPriceSettings> Get()
        {
            return _settingsRootService.Get().AssetPairs
                .ToImmutableSortedDictionary(a => a.Key, a => a.Value.ExtPriceSettings);
        }
        ...
        {
            return _settingsRootService.Get().AssetPairs
                .ToImmutableSortedDictionary(a => a.Key, a => a.Value.ExtPriceSettings.Exchanges);
        }
        ...
        private ImmutableSortedDictionary<string, ExchangeExtPriceSettings> GetAllExchanges(string assetPairId)
        {
        ...
        {
            ImmutableSortedDictionary<string, ExchangeExtPriceSettings> oldExchanges = null;
            ImmutableSortedDictionary<string, ExchangeExtPriceSettings> newExchanges = null;
        ...
        public ImmutableSortedDictionary<OrderbookGeneratorStepDomainEnum, bool> GetDefaultSteps()
        {
            return Enum.GetValues(typeof(OrderbookGeneratorStepDomainEnum)).Cast<OrderbookGeneratorStepDomainEnum>()
                .ToImmutableSortedDictionary(e => e, e => DefaultStepEnabled);
        }
    }
}